...
import { fetchWithRetry, getTimeBefore3600SecondsAlt, saveCsv } from "../utilities";
 ...
 * @returns 
 */
export async function downloadAllEventsOfLastOneHour(
    clientId: string,
    clientSecret: string,
    instanceUrl: string,
    subscriptionId: string,
    ...
    const since = getTimeBefore3600SecondsAlt();
